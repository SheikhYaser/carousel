    ...
    <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">${{ $price->month_price }}<small class="text-body-secondary fw-light">/mo</small></h1>
      ...
      <table class="table text-center">
        <thead>
          <tr>
            ...
            @foreach ($prices as $price)
            <th style="width: 22%;">{{ $price->name }}</th>
            @endforeach
          </tr>
        </thead>
        ...
        <tbody>
          ...
          <tr>
              <th scope="row" class="text-start">{{ $plan->name }}</th>
              @foreach ($prices as $price)
              <td>
                @if ($price->have_plan($plan->id) != null)
