                    ...
                    <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-start">
                                <h1>{{ $slader->title }}</h1>
                                <p class="opacity-75">{{ $slader->content }}</p>
            ...
            <div class="row">
                @foreach ($posts as $post)
                    <div class="col-lg-4">
                        ...
                        <p>{{ $post->content }}</p>
                        <p><a class="btn btn-secondary" href="#">View detail &raquo;</a></p>
                    </div>
                @endforeach
            </div>
            ...
            @foreach ($blogs as $blog)
                ...
                <div class="row featurette">
                    <div class="col-md-7 {{ $loop->even ? 'order-md-2' : '' }}">
                        <h2 class="featurette-heading fw-normal lh-1">{{ $blog->title }}</h2>
